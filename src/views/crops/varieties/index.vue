    ...
    <el-card shadow="never">
      ...
      >
        ...
        <template slot="toolbar">
          <el-button
            v-permission="'crop_varietie_add'"
            type="primary"
            icon="el-icon-plus"
            class="ele-btn-icon"
            @click="saveJobType"
        ...
        <template slot="action" slot-scope="{ row }">
          ...
          <el-popconfirm
            v-permission="'crop_varietie_del'"
            class="ele-action"
            title="确定要删除吗？"
...
<script>
import {
  PostCropVarietiesSave,
  PutCropVarietiesUpdate,
  DeleteCropVarieties
} from "@/api/cropVarieties";
...
export default {
  ...
  methods: {
    ...
    async GetCropTypesList() {
      ...
      this.JobTypeLength = myData.length;
      for (let r of myData) {
